...
namespace DOL.Database
{
    ...
    public class DBKeepComponent : DataObject
    {
        ...
        /// Create a component of keep (wall, tower,gate, ...)
        /// </summary>
        public DBKeepComponent(int componentID, int componentSkinID, int componentX, int componentY, int componentHead, int componentHeight, int componentHealth, int keepid, string createInfo)
            : this()
        {
