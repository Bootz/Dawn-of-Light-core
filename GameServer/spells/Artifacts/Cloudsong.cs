...
namespace DOL.GS.Spells
{
    ...
    {
        public CloudsongAuraSpellHandler(GameLiving caster, Spell spell, SpellLine line)
    ...
    {
        public CloudsongFallSpellHandler(GameLiving caster, Spell spell, SpellLine line)
            : base(caster, spell, line)
        {
        }
