...
namespace DOL.GS.Spells
{
    ...
    public class HereticSpeedDecreaseSpellHandler : HereticImmunityEffectSpellHandler
    {
        ...
        public HereticSpeedDecreaseSpellHandler(GameLiving caster, Spell spell, SpellLine line)
        ...
        private sealed class RestoreSpeedTimer : GameTimer
        {
            ...
            public RestoreSpeedTimer(GameSpellEffect effect)
                : base(effect.Owner.CurrentRegion.TimeManager)
            {
                m_effect = effect;
            }
