...
namespace DOL.GS.Spells
{
    ...
    #endregion Spymaster-2

    #region Spymaster-3

    //Gameliving - StartWeaponMagicalEffect

    #endregion Spymaster-3
