...
namespace DOLConfig
{
    public partial class DolConfig : Form
    {
        ...
        /// <returns></returns>
        private bool IsText(ServerProperty this_sp)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void Tv_spShowAfterSelect(object sender, TreeViewEventArgs e)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void Bu_spChangeClick(object sender, EventArgs e)
        {
            if (IsText(selected_sp))
