...
namespace DOL.GS.Quests.Hibernia
{
    ...
    public class CityOfTirnaNog : BaseAddrirQuest
    {
        ...
        public CityOfTirnaNog()
            : base()
        {
        }

        public CityOfTirnaNog(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public CityOfTirnaNog(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public CityOfTirnaNog(GamePlayer questingPlayer, DBQuest dbQuest)
