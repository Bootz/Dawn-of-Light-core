...
namespace DOL.GS.Quests.Hibernia
{
    ...
    public abstract class BaseAddrirQuest : BaseQuest
    {
        ...
        public BaseAddrirQuest()
            : base()
        {
        }

        public BaseAddrirQuest(GamePlayer questingPlayer)
            : base(questingPlayer)
        {
        }

        public BaseAddrirQuest(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public BaseAddrirQuest(GamePlayer questingPlayer, DBQuest dbQuest)
