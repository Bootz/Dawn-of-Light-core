...
namespace DOL.GS.Quests.Hibernia
{
    public class Essence_50 : BaseQuest
    {
        ...
        public Essence_50(GamePlayer questingPlayer)
            : base(questingPlayer)
        {
        }

        public Essence_50(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public Essence_50(GamePlayer questingPlayer, DBQuest dbQuest)
        ...
        */
        ...
        #endregion Allakhazam Epic Source
    }
}
