...
namespace DOL.GS.Quests.Hibernia
{
    ...
    public class TraitorInMagMell : BaseAddrirQuest
    {
        ...
        public TraitorInMagMell()
            : base()
        {
        }

        public TraitorInMagMell(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public TraitorInMagMell(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public TraitorInMagMell(GamePlayer questingPlayer, DBQuest dbQuest)
