...
namespace DOL.GS.Quests.Hibernia
{
    ...
    public class Nuisances : BaseAddrirQuest
    {
        ...
        public Nuisances(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public Nuisances(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public Nuisances(GamePlayer questingPlayer, DBQuest dbQuest)
