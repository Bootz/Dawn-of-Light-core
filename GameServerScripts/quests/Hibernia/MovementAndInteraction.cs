...
namespace DOL.GS.Quests.Hibernia
{
    public class MovementAndInteraction : BaseQuest
    {
        ...
        public MovementAndInteraction()
            : base()
        {
            Init();
        }

        public MovementAndInteraction(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
            Init();
        }

        public MovementAndInteraction(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
            Init();
        }

        public MovementAndInteraction(GamePlayer questingPlayer, DBQuest dbQuest)
