...
namespace DOL.GS.Quests.Albion
{
    ...
    public class CityOfCamelot : BaseFrederickQuest
    {
        ...
        public CityOfCamelot()
            : base()
        {
        }

        public CityOfCamelot(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public CityOfCamelot(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public CityOfCamelot(GamePlayer questingPlayer, DBQuest dbQuest)
