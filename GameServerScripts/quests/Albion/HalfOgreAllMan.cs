...
namespace DOL.GS.Quests.Albion
{
    ...
    public class HalfOgreAllMan : BaseQuest
    {
        ...
        */
        ...
        public HalfOgreAllMan()
            : base()
        {
        }

        public HalfOgreAllMan(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public HalfOgreAllMan(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public HalfOgreAllMan(GamePlayer questingPlayer, DBQuest dbQuest)
