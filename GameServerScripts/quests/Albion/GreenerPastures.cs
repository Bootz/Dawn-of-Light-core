...
namespace DOL.GS.Quests.Albion
{
    ...
    public class GreenerPastures : BaseQuest
    {
        ...
        public GreenerPastures(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public GreenerPastures(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public GreenerPastures(GamePlayer questingPlayer, DBQuest dbQuest)
