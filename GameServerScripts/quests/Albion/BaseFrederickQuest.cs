...
namespace DOL.GS.Quests.Albion
{
    ...
    public abstract class BaseFrederickQuest : BaseQuest
    {
        ...
        public BaseFrederickQuest()
            : base()
        {
        }

        public BaseFrederickQuest(GamePlayer questingPlayer)
            : base(questingPlayer)
        {
        }

        public BaseFrederickQuest(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public BaseFrederickQuest(GamePlayer questingPlayer, DBQuest dbQuest)
