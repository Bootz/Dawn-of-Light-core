...
namespace DOL.GS.Quests.Albion
{
    ...
    public class IreFairyIre : BaseFrederickQuest
    {
        ...
        public IreFairyIre(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public IreFairyIre(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public IreFairyIre(GamePlayer questingPlayer, DBQuest dbQuest)
