    ...
    */
    ...
    public class Cellarinfestation : BaseQuest
    {
        ...
        */
        ...
        public Cellarinfestation()
            : base()
        {
        }

        public Cellarinfestation(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public Cellarinfestation(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public Cellarinfestation(GamePlayer questingPlayer, DBQuest dbQuest)
