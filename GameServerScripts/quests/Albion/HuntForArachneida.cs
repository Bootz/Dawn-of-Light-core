...
namespace DOL.GS.Quests.Albion
{
    ...
    public class HuntForArachneida : BaseQuest
    {
        ...
        public HuntForArachneida()
            : base()
        {
        }

        public HuntForArachneida(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public HuntForArachneida(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public HuntForArachneida(GamePlayer questingPlayer, DBQuest dbQuest)
