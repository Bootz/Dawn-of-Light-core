...
namespace DOL.GS.Quests.Albion
{
    ...
    public class RevengeTheOtherWhiteMeat : BaseQuest
    {
        ...
        public RevengeTheOtherWhiteMeat()
            : base()
        {
        }

        public RevengeTheOtherWhiteMeat(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public RevengeTheOtherWhiteMeat(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public RevengeTheOtherWhiteMeat(GamePlayer questingPlayer, DBQuest dbQuest)
