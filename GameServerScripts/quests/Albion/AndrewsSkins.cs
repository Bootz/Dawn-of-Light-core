...
namespace DOL.GS.Quests.Albion
{
    ...
    public class AndrewsSkins : BaseQuest
    {
        ...
        public AndrewsSkins(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public AndrewsSkins(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public AndrewsSkins(GamePlayer questingPlayer, DBQuest dbQuest)
