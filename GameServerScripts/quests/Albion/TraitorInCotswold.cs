...
namespace DOL.GS.Quests.Albion
{
    ...
    public class TraitorInCotswold : BaseFrederickQuest
    {
        ...
        public TraitorInCotswold()
            : base()
        {
        }

        public TraitorInCotswold(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public TraitorInCotswold(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public TraitorInCotswold(GamePlayer questingPlayer, DBQuest dbQuest)
