...
namespace DOL.GS.Quests.Albion
{
    ...
    public class BuildingABetterBow : BaseQuest
    {
        ...
        public BuildingABetterBow()
            : base()
        {
        }

        public BuildingABetterBow(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public BuildingABetterBow(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public BuildingABetterBow(GamePlayer questingPlayer, DBQuest dbQuest)
