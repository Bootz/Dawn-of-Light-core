...
namespace DOL.GS.Quests.Albion
{
    ...
    public class YdeniasCrush : BaseQuest
    {
        ...
        public YdeniasCrush(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public YdeniasCrush(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public YdeniasCrush(GamePlayer questingPlayer, DBQuest dbQuest)
