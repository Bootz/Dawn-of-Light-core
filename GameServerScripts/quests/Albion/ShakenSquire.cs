...
namespace DOL.GS.Quests.Albion
{
    ...
    public class ShakenSquire : BaseQuest
    {
        ...
        public ShakenSquire(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public ShakenSquire(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public ShakenSquire(GamePlayer questingPlayer, DBQuest dbQuest)
