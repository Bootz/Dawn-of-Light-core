...
namespace DOL.GS.Quests.Albion
{
    ...
    public class HeartOfSephucoth : BaseQuest
    {
        ...
        public HeartOfSephucoth()
            : base()
        {
        }

        public HeartOfSephucoth(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public HeartOfSephucoth(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public HeartOfSephucoth(GamePlayer questingPlayer, DBQuest dbQuest)
