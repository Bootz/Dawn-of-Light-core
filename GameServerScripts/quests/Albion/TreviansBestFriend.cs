...
namespace DOL.GS.Quests.Albion
{
    ...
    public class TreviansBestFriend : BaseQuest
    {
        ...
        public TreviansBestFriend()
            : base()
        {
        }

        public TreviansBestFriend(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public TreviansBestFriend(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public TreviansBestFriend(GamePlayer questingPlayer, DBQuest dbQuest)
