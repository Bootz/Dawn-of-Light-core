...
namespace DOL.GS.Quests.Albion
{
    ...
    public class WolfPeltCloak : BaseQuest
    {
        ...
        public WolfPeltCloak()
            : base()
        {
        }

        public WolfPeltCloak(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public WolfPeltCloak(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public WolfPeltCloak(GamePlayer questingPlayer, DBQuest dbQuest)
