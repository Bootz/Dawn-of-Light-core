...
namespace DOL.GS.Quests.Albion
{
    ...
    public class HuntForSlith : BaseQuest
    {
        ...
        public HuntForSlith(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public HuntForSlith(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public HuntForSlith(GamePlayer questingPlayer, DBQuest dbQuest)
