...
namespace DOL.GS.Quests.Albion
{
    ...
    public class ArrowsForYettaFletcher : BaseQuest
    {
        ...
        public ArrowsForYettaFletcher()
            : base()
        {
        }

        public ArrowsForYettaFletcher(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public ArrowsForYettaFletcher(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public ArrowsForYettaFletcher(GamePlayer questingPlayer, DBQuest dbQuest)
