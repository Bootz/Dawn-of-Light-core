...
namespace DOL.GS.Quests.Albion
{
    public class Defenders_50 : BaseQuest
    {
        ...
        public Defenders_50(GamePlayer questingPlayer)
            : base(questingPlayer)
        {
        }

        public Defenders_50(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public Defenders_50(GamePlayer questingPlayer, DBQuest dbQuest)
