...
namespace DOL.GS.Quests.Albion
{
    public class Academy_50 : BaseQuest
    {
        ...
        public Academy_50(GamePlayer questingPlayer)
            : base(questingPlayer)
        {
        }

        public Academy_50(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public Academy_50(GamePlayer questingPlayer, DBQuest dbQuest)
