...
namespace DOL.GS.Quests.Albion
{
    public class Church_50 : BaseQuest
    {
        ...
        public Church_50(GamePlayer questingPlayer)
            : base(questingPlayer)
        {
        }

        public Church_50(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public Church_50(GamePlayer questingPlayer, DBQuest dbQuest)
