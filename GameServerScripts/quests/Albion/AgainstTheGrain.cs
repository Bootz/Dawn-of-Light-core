...
namespace DOL.GS.Quests.Albion
{
    ...
    public class AgainstTheGrain : BaseQuest
    {
        ...
        public AgainstTheGrain()
            : base()
        {
        }

        public AgainstTheGrain(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public AgainstTheGrain(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public AgainstTheGrain(GamePlayer questingPlayer, DBQuest dbQuest)
