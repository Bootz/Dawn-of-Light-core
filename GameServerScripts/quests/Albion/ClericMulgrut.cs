...
namespace DOL.GS.Quests.Albion
{
    ...
    public class ClericMulgrut : BaseQuest
    {
        ...
        public ClericMulgrut()
            : base()
        {
        }

        public ClericMulgrut(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public ClericMulgrut(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public ClericMulgrut(GamePlayer questingPlayer, DBQuest dbQuest)
