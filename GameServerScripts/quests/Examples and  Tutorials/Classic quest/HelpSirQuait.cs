    ...
    */
    ...
    public class HelpSirQuait : BaseQuest
    {
        ...
        */
        ...
        public HelpSirQuait(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public HelpSirQuait(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public HelpSirQuait(GamePlayer questingPlayer, DBQuest dbQuest)
