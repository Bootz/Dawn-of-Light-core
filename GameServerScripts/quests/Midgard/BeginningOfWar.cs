...
namespace DOL.GS.Quests.Midgard
{
    ...
    public class BeginningOfWar : BaseDalikorQuest
    {
        ...
        public BeginningOfWar()
            : base()
        {
        }

        public BeginningOfWar(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public BeginningOfWar(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public BeginningOfWar(GamePlayer questingPlayer, DBQuest dbQuest)
