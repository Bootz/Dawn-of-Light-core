    ...
    */
    ...
    public class sveabonehiltsword : BaseQuest
    {
        ...
        */
        ...
        public sveabonehiltsword()
            : base()
        {
        }

        public sveabonehiltsword(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public sveabonehiltsword(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public sveabonehiltsword(GamePlayer questingPlayer, DBQuest dbQuest)
