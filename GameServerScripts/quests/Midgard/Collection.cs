...
namespace DOL.GS.Quests.Midgard
{
    ...
    public class Collection : BaseDalikorQuest
    {
        ...
        public Collection(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public Collection(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public Collection(GamePlayer questingPlayer, DBQuest dbQuest)
