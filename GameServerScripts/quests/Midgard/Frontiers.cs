...
namespace DOL.GS.Quests.Midgard
{
    ...
    public class Frontiers : BaseDalikorQuest
    {
        ...
        public Frontiers(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public Frontiers(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public Frontiers(GamePlayer questingPlayer, DBQuest dbQuest)
