...
namespace DOL.GS.Quests.Midgard
{
    ...
    public class TraitorInMularn : BaseDalikorQuest
    {
        ...
        public TraitorInMularn()
            : base()
        {
        }

        public TraitorInMularn(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public TraitorInMularn(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public TraitorInMularn(GamePlayer questingPlayer, DBQuest dbQuest)
