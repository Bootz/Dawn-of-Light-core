    ...
    */
    ...
    public class thebirthdaygift : BaseQuest
    {
        ...
        */
        ...
        public thebirthdaygift()
            : base()
        {
        }

        public thebirthdaygift(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public thebirthdaygift(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public thebirthdaygift(GamePlayer questingPlayer, DBQuest dbQuest)
