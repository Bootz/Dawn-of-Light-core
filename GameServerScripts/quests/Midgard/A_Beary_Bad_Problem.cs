    ...
    */
    ...
    public class Abearybadproblem : BaseQuest
    {
        ...
        */
        ...
        public Abearybadproblem()
            : base()
        {
        }

        public Abearybadproblem(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public Abearybadproblem(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public Abearybadproblem(GamePlayer questingPlayer, DBQuest dbQuest)
