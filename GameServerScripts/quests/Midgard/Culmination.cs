...
namespace DOL.GS.Quests.Midgard
{
    ...
    public class Culmination : BaseDalikorQuest
    {
        ...
        public Culmination(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public Culmination(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public Culmination(GamePlayer questingPlayer, DBQuest dbQuest)
