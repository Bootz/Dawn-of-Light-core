    ...
    */
    ...
    public class Bearskins : BaseQuest
    {
        ...
        */
        ...
        public Bearskins(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public Bearskins(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public Bearskins(GamePlayer questingPlayer, DBQuest dbQuest)
