    ...
    */
    ...
    public class Amorasaidmistyc : BaseQuest
    {
        ...
        */
        ...
        public Amorasaidmistyc()
            : base()
        {
        }

        public Amorasaidmistyc(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public Amorasaidmistyc(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public Amorasaidmistyc(GamePlayer questingPlayer, DBQuest dbQuest)
