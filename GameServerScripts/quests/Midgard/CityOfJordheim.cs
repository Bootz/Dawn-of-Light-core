...
namespace DOL.GS.Quests.Midgard
{
    ...
    public class CityOfJordheim : BaseDalikorQuest
    {
        ...
        public CityOfJordheim()
            : base()
        {
        }

        public CityOfJordheim(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public CityOfJordheim(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public CityOfJordheim(GamePlayer questingPlayer, DBQuest dbQuest)
