    ...
    */
    ...
    public class essenceoflife : BaseQuest
    {
        ...
        */
        ...
        public essenceoflife()
            : base()
        {
        }

        public essenceoflife(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public essenceoflife(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public essenceoflife(GamePlayer questingPlayer, DBQuest dbQuest)
