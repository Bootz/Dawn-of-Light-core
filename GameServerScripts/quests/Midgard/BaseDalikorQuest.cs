...
namespace DOL.GS.Quests.Midgard
{
    ...
    public abstract class BaseDalikorQuest : BaseQuest
    {
        ...
        public BaseDalikorQuest()
            : base()
        {
        }

        public BaseDalikorQuest(GamePlayer questingPlayer)
            : base(questingPlayer)
        {
        }

        public BaseDalikorQuest(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public BaseDalikorQuest(GamePlayer questingPlayer, DBQuest dbQuest)
