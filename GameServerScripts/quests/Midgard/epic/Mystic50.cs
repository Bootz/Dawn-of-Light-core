...
namespace DOL.GS.Quests.Midgard
{
    public class Mystic_50 : BaseQuest
    {
        ...
        public Mystic_50(GamePlayer questingPlayer)
            : base(questingPlayer)
        {
        }

        public Mystic_50(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public Mystic_50(GamePlayer questingPlayer, DBQuest dbQuest)
