...
namespace DOL.GS.Quests.Midgard
{
    public class Viking_50 : BaseQuest
    {
        ...
        public Viking_50(GamePlayer questingPlayer)
            : base(questingPlayer)
        {
        }

        public Viking_50(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public Viking_50(GamePlayer questingPlayer, DBQuest dbQuest)
