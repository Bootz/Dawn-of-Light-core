    ...
    */
    ...
    public class maulerinvasion : BaseQuest
    {
        ...
        */
        ...
        public maulerinvasion()
            : base()
        {
        }

        public maulerinvasion(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public maulerinvasion(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public maulerinvasion(GamePlayer questingPlayer, DBQuest dbQuest)
