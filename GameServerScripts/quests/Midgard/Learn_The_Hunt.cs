    ...
    */
    ...
    public class Learnthehunt : BaseQuest
    {
        ...
        */
        ...
        public Learnthehunt(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public Learnthehunt(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public Learnthehunt(GamePlayer questingPlayer, DBQuest dbQuest)
