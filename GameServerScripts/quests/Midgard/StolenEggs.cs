...
namespace DOL.GS.Quests.Midgard
{
    ...
    public class StolenEggs : BaseDalikorQuest
    {
        ...
        public StolenEggs(GamePlayer questingPlayer)
            : this(questingPlayer, 1)
        {
        }

        public StolenEggs(GamePlayer questingPlayer, int step)
            : base(questingPlayer, step)
        {
        }

        public StolenEggs(GamePlayer questingPlayer, DBQuest dbQuest)
